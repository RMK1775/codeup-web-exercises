...
describe("returnEvenOddMessage", function() {
    ...
    it("should return the correct message when passed an integer", function() {
        ...
        expect(returnEvenOddMessage(10)).toEqual("10 is even.");
        expect(returnEvenOddMessage(7)).toEqual("7 is odd.");
    });
});
...
describe("returnNumberSail", function() {
    ...
    var expectedValue = "1\n" +
        ...
        "88888888\n" +
        "999999999";
    it('should return a string matching expectedValue', function () {
...
describe("returnCountDownFrom100InFives", function(){
    ...
    "5"
    it('should return a string matching expectedValue', function () {
        expect(returnCountDownFrom100InFives()).toEqual(expectedValue);
    });
})